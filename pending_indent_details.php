              ...
              <div class="col-md-9 col-xs-9" style="padding:0px;">
                <div class="card " style="border:1px solid #7c1ab5">
                  <div class="card-header cardhdd">
						<h5 class="box-title" style="color:#fff;">Pending Indent Details</h5>
						<div class="row pull-right">
							<div class="col-md-12">
								<a class="btn btn-light" style="margin-right:5px;" href="#">Approved</a>
								<a class="btn btn-light" style="margin-right:5px;" href="#">Not approved</a>
