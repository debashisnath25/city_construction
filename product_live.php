...
<html lang="en">
  <head>
    ...
    <title>Products Live | Wanted 7</title>
    <?php
					...
					<div class="col-lg-9">
						<div class="card" style="border:1px solid #7c1ab5">
							<div class="card-header cardhdd">
								<h5 class="box-title" style="color:#fff;">Live Products Lists</h5>
                                    ...
                                    <table class="table table-bordered table-striped w-100" id="dt-buttons">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
												...
												<td>
													<label class="ui-switch switch-solid mt-2"><input type="checkbox" checked=""><span></span></label>
												</td>
                                            </tr>
											<?php
												}
