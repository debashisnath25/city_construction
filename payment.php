						...
						<div class="tab-pane fade active show" id="faq-group-1">
							<div class="card" style="border:1px solid #7c1ab5">
								<div class="card-header cardhdd">
									<h5 class="box-title" style="color:#fff;">Payment Pending</h5>
										...
										<table class="table table-bordered table-striped w-100" id="dt-buttons">
											...
											<tbody>
												...
												<tr>
													...
													<td> Amount <b style="font-family:Arial;color:#7c1ab5;">&#8377; 4,000</b>&nbsp;&nbsp;Pending For Order Id <b style="font-family:Arial;color:#7c1ab5;"><a href="order_details.php">#order123</a></b></td>
													
													<td>Awaiting Acceptence</td>
													<td><a href="view_payment_trans.php" class="btn btn-outline-warning"> View Order</a></td>
												...
												<tr>
													<td>#108737<?php echo $i;?></td>
													<td>01/02/2019 : 7:00 PM </td>
													<td> Amount <b style="font-family:Arial;color:#7c1ab5;">&#8377; 5,000</b>&nbsp;&nbsp;Pending For Order Id <b style="font-family:Arial;color:#7c1ab5;"><a href="order_details.php">#order124</a></b></td>
												...
												<tr>
													<td>#108737<?php echo $i;?></td>
													<td>01/02/2019 : 7:00 PM </td>
													<td>Amount <b style="font-family:Arial;color:#7c1ab5;">&#8377; 6,000</b>&nbsp;&nbsp;Pending For Order Id <b style="font-family:Arial;color:#7c1ab5;"><a href="order_details.php">#order125</a></b></td>
