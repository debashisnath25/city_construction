...
<html lang="en">
  <head>
    ...
    <title>Payments Settled | Wanted 7
    </title>
    <?php
						...
						<div class="tab-pane fade active show" id="faq-group-1">
							<div class="card" style="border:1px solid #7c1ab5">
								<div class="card-header cardhdd">
									<h5 class="box-title" style="color:#fff;">Payment Settled</h5>
										...
										<table class="table table-bordered table-striped w-100" id="dt-buttons">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="settled_payment_trans.php" class="btn btn-outline-warning mb-2"> View Order</a>
