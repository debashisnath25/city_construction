                          ...
                          <div class="row mb-3" style="border:1px solid #ccc;">
                            <div class="order_div col-md-12 pt-3 ">
								<div class="row" style="margin:0px;padding:0px;">
									<div class="col-md-2 col-sm-12 col-xs-12 mb-3" style="text-align:center;padding:3px !important;">
										<a href="order_details.php" class="btn btn-primary ordr_btn" style="margin-left:-10px;margin-top:-5px;background:transparent;padding:7px;width: 100%;">
									...
									<div class="col-md-2 col-sm-12 col-xs-12 mb-3 " style="text-align:center;padding:3px !important;">
									  <button class="btn btn-primary" style="color:#fff;background:#09d261;border:1px solid #09d261;" type="submit">Accept Order
									  </button>
									</div>
									<div class="col-md-2 col-sm-12 col-xs-12 mb-3 " style="text-align:center;padding:3px !important;">
									  <button class="btn btn-warning" style="background:#eb5757;color:#fff;" type="submit">Cancel Order 
									  </button>
									</div>
								</div>
                          </div>
