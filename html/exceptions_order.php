          ...
          <div class="page-content fade-in-up">
            ...
            <div class="page-heading">
              <div class="page-breadcrumb">
                <h1 class="page-title"><a href="dashboard.php">Dashboard </a>> Orders > Exceptions orders shipped
                </h1>
              </div>
            </div>
            <!-- BEGIN: Page content-->
                    ...
                    <div class="tab-pane fade active show" id="faq-group-1">
                      <div class="card" style="border:1px solid #7c1ab5">
                        <div class="card-header cardhdd">
                          <h5 class="box-title" style="color:#fff;">SHIPPING EXPECTIONS FOR ORDERS SHIPPED
                          </h5>
                        ...
                        <div class="card-body">
						  ...
						  <?php for($i=0; $i<4; $i++){?>
										  <div class="row mb-3" style="border:1px solid #ccc;">
											...
											<div class="col-md-2 col-sm-6 col-xs-6 mb-3" style="float:left;padding:3px !important;">
											  <h5 class="text-primary mb-1 font-15" style="color:#343a40 !important;">Delivery Status
											  </h5>
											  <div class="font-13 text-muted">
												<div class=" text-muted" style="color:#2949ef !important;">
												  <?php if($i==0){echo "Customer address doesn't exists.";}?>
												  <?php if($i==1){echo "Customer un-reachable";}?>
												  <?php if($i==2){echo "Customer soo gaya phone nehi uthaya";}?>
												  <?php if($i==3){echo "Customer address not found.";}?>
												</div>
											  </div>
											</div>

											<div class="col-md-2 col-sm-6 col-xs-6 mb-3" style="float:left;padding:3px !important;">
											  <button class="btn btn-primary pull-right" style="color:#fff;background:#09d261;border:1px solid #09d261;" type="submit">Reshedule</button>
											  <button class="btn btn-warning pull-right" style="background:#eb5757;color:#fff;margin-top:5px;" type="submit">Cancel Order </button>
											</div>
