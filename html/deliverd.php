           ...
           <!-- BEGIN: Page heading-->
            <div class="page-heading">
              <div class="page-breadcrumb">
                <h1 class="page-title"><a href="dashboard.php">Dashboard </a>> Orders > rders delivered
                </h1>
              </div>
            </div>
            <!-- BEGIN: Page content-->
                    ...
                    <div class="tab-pane fade active show" id="faq-group-1">
                      <div class="card" style="border:1px solid #7c1ab5">
                        <div class="card-header cardhdd">
                          <h5 class="box-title" style="color:#fff;">ORDERS DELIVERED TO CUSTOMERS
                          </h5>
                        ...
                        <div class="card-body">
                          ...
                          <div class="row mb-3" style="border:1px solid #ccc;">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-6 mb-3 " style="float:left;padding:3px !important;">
                              <button class="btn btn-primary pull-right" style="color:#fff;background:#09d261;border:1px solid #09d261;" type="submit">View Invoice
                              </button>
                            </div>
                          </div>
