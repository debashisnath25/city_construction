          ...
          <div class="page-content fade-in-up">
            ...
            <div class="page-heading" style="padding-left:17px;">
              <div class="page-breadcrumb">
                <h1 class="page-title"><a href="dashboard.php">Dashboard </a>>Product > Category
                </h1>
              </div>
            </div>
            <!-- BEGIN: Page content-->
              ...
              <div class="col-lg-12">
                <div class="row">
                  <div class="col-md-12">
				  	<div class="row mb-3">
						<div class="col-md-12">
							<button class="btn btn-primary clr" data-toggle="modal" data-target="#exampleLargeModal"><span class="btn-icon"><i class="fas fa-plus"></i>Add Category</span></button>
						...
						<div class="card" style="border:1px solid #7c1ab5">
							   <div class="card-header cardhdd">
								<h5 class="box-title" style="color:#fff;">All Categories List</h5>
								<div class="row pull-right">
									<div class="col-md-12">
										<button class="btn btn-default del " data-toggle="modal" data-target="#exampleLargeModal"><span class="btn-icon"><i class="fas fa-plus"></i>Add New Category</span></button>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped w-100" id="dt-buttons_1">
                                            <thead class="">
                                            <tr>
												<th style="min-width:140px;">Category Image</th>
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header cardhdd">
							<h5 class="modal-title h4" id="exampleLargeModalLabel" style="color:#fff;">Add Category</h5><button class="close" type="button" data-dismiss="modal" aria-label="Close"><i class="fas fa-times" style="font-size:15px;color:#fff;"></i></button>
						</div>
						<div class="modal-body">
						   <div class="form-group mb-4 row">
								<dt class="col-sm-3" style="padding-top:10px;">Name</dt>
								<div class="col-sm-9">
									<input class="form-control form-control-solid theme_border" id="validationCustom03" type="text" placeholder="Enter Category Name" required="">
								</div>
